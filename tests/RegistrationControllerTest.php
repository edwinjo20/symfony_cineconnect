...
class RegistrationControllerTest extends WebTestCase
{
    ...
    public function testRegister(): void
    {
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'mailer@cineconnect.com');
        ...
        self::assertTrue(static::getContainer()->get(EntityManagerInterface::class)->findAll()[0]->isVerified());
    }
}
