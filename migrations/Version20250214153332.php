 ...
 */
final class Version20250214153332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE film ADD genre_id INT NOT NULL, DROP genre');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE film ADD genre VARCHAR(50) NOT NULL, DROP genre_id');
    }
}
